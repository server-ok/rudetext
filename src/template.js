...
export default function template(configgers) {
    ...
    var element = `
        <svg width="${configgers.font_size*configgers.text.length}" height="${configgers.font_size}" viewBox="0 0 500 200" fill="none" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        <style>
