import punky as punky from "./fonts/base64.js"
...
export default function template(configgers) {
    ...
    <text class="THEtext" x="${configgers.anchor == "middle" ? "50%" : (configgers.anchor == "end" ? "100%" : "0%")}" y="50%" dominant-baseline="middle" text-anchor="${configgers.anchor}">${configgers.text}</text>
    </svg>
    `
